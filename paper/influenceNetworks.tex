...
\hypersetup{%
	...
	pdftitle={Decomposing Network Dynamics: Social Influence Regression},%
	colorlinks,%
	citecolor=black,%
	filecolor=black,%
	linkcolor=black,%
...
\title{Decomposing Network Dynamics: Social Influence Regression}
\vspace{\baselineskip}
...
Replication code for this article is available at \citet{minhas:hoff:2025}. A preservation copy of the same code and data can also be accessed via Dataverse at \url{https://doi.org/10.7910/DVN/VTFDX6}.

\section*{Author ORCiDs}

Shahryar Minhas \url{https://orcid.org/0000-0002-8498-4005}

Peter D. Hoff \url{https://orcid.org/0000-0001-8041-0322}
...
All authors contributed to the mathematical analysis, statistical simulations, and empirical statistical analyses.

\section*{Financial Support/Funding Statement}

This work was supported by the National Science Foundation [Award 2017180 to S.M., Award 1505136 to P.H.].

\section*{Conflict(s) of Interest}
...
Shahryar Minhas is an Associate Professor in the Department of Political Science at Michigan State University. 

Peter D. Hoff is a James B. Duke Distinguished Professor of Statistical Science at Duke University.
